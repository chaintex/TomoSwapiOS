...
extension KNAppCoordinator {
  func startNewSession(with wallet: Wallet) {
    ...
    self.tabbarController.tabBar.tintColor = UIColor(hex: "43508e")
    ...
    self.exchangeCoordinator?.navigationController.tabBarItem = UITabBarItem(
      title: NSLocalizedString("tomoswap", value: "TomoSwap", comment: ""),
    ...
    self.settingsCoordinator?.navigationController.tabBarItem.tag = 2
