...
class KNPasscodeViewController: KNBaseViewController {
  ...
  fileprivate func setupUI() {
    ...
    self.digitButtons.forEach({
      ...
      $0.setBackgroundColor(UIColor(hex: "313b6e"), forState: .highlighted)
      $0.setTitleColor(UIColor(hex: "313b6e"), for: .normal)
  ...
  fileprivate func updateUI() {
    ...
    self.passcodeViews.forEach({ $0.backgroundColor = $0.tag < self.currentPasscode.count ? UIColor(hex: "313b6e") : UIColor.Kyber.passcodeInactive })
    self.actionButton.setTitle(self.actionButtonTitle, for: .normal)
