...
class KNPasscodeUtil {
  ...
  private let kServiceKey: String = "tomoswapwallet.authentication"
  private let kAccountKey: String = "tomoswapwallet.account"
  static private let kKeychainPrefix: String = "tomoswapwallet"
