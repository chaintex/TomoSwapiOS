...
class KNBackUpWalletViewModel {
  ...
  var backUpDescAttributedString: NSMutableAttributedString {
    ...
    let restoreText = NSLocalizedString("restore.your.kyber.wallet.if.you.lose.your.phone", value: "to restore your TomoSwap Wallet if you lose your phone or forget your password.", comment: "")
