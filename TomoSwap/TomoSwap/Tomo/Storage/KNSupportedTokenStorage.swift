...
class KNSupportedTokenStorage {
  ...
  var tomoToken: TokenObject {
    return self.supportedTokens.first(where: { return $0.isTOMO })!
  }

  var defaultToken: TokenObject {
    return self.supportedTokens.first(where: { $0.isCTT })!
  }
